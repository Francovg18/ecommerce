...
def assign_user_group(sender, instance, created, **kwargs):
    if created:
        if instance.email == "admin@gmail.com":
        ...
        elif instance.mayorista_tipo in [1, 2, 3]:
            mayorista_group, _ = Group.objects.get_or_create(
                name=f"Mayorista {instance.mayorista_tipo}")
            instance.groups.add(mayorista_group)
