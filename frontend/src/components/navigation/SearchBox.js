    ...
    >
      <div className="hidden lg:block relative">
        <select
          ...
          name="category_id"
          className="h-full text-sm text-gray-700 bg-white border-r-2 border-purple-night px-6 py-2 outline-none focus:ring-deep-rose"
        >
      ...
      <input
        ...
        value={search}
        required
        className="flex-grow text-sm text-gray-700 bg-white px-4 py-2 outline-none focus:ring-purple-night focus:border-crimson-red w-full"
