        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                ...
                <label
                    key={type}
                    className="relative flex flex-col items-center justify-center  p-3 border border-solid border-midnight-blue rounded-lg bg-blue-50 cursor-pointer hover:bg-blue-100"
                >
