...
function UserRegister() {
  ...
  <div className="max-w-2xl mx-auto p-8 bg-white shadow-xl rounded-3xl border border-gray-200">
    ...
    <div className="text-gray-600 text-center mb-6">
          Nos especializamos en ventas mayoristas y no comercializamos directamente con clientes finales. Evaluaremos la información proporcionada para verificar si califica para registrarse como cliente.
        </div>
