        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            <input
                ...
                required
                onChange={onChange}
                className="w-full p-12 border border-gray-300 rounded-lg bg-gray-100 focus:border-purple-600 focus:ring focus:ring-purple-300"
            />
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <label
                    key={type}
                    className="relative flex flex-col items-center justify-center gap-2 p-3 border-2 border-dashed border-purple-600 rounded-lg bg-blue-50 cursor-pointer hover:bg-blue-100"
                >
                    <CloudUploadIcon className="h-6 w-6 text-purple-600" />
