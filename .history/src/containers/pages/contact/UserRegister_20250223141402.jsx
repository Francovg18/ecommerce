        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-12">
                ...
                <label
                    key={type}
                    className="relative flex flex-col items-center justify-center  p-3 border-2 border-dashed border-midnight-blue rounded-lg bg-blue-50 cursor-pointer hover:bg-blue-100"
                >
                    ...
                    <img
                        ...
                        className="mt-2 w-1 h-32 object-cover rounded-lg border border-gray-300"
                    />
                    )}
                </label>
                ))}
