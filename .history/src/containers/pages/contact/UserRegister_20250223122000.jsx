...
function UserRegister() {
  ...
  return (
    <FullWidthLayout>
  <div className="max-w-2xl mx-auto p-8 bg-white shadow-xl rounded-3xl border border-gray-200">
    <h2 className="text-4xl font-extrabold text-gray-800 text-center mb-6">Pre-Registro de Usuario</h2>
    <p className="text-gray-600 text-center mb-8">
      Recuerde que somos distribuidores mayoristas y no comercializamos con clientes finales. La información que nos está proporcionando será evaluada por el área comercial para determinar si podemos o no registrarlo como cliente.
    </p>
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <button type="submit" className="w-full py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 transition-all">
