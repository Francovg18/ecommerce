...
function UserRegister() {
  ...
  return (
    <FullWidthLayout className="bg-blue-500">
      <div className="max-w-3xl mx-auto p-10 bg-white shadow-2xl rounded-3xl border border-gray-200 py-16">
        ...
        <form onSubmit={onSubmit} className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <label className="flex items-center justify-center gap-2 p-3 border-2 border-dashed border-midnight-blue rounded-lg bg-blue-50 cursor-pointer hover:bg-blue-100">
