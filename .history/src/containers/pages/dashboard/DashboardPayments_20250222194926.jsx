...
const statusStyles = {
  'Not Processed': 'bg-gray-400 text-white',
  'Processed': 'bg-blue-500 text-white',
  'Shipping': 'bg-orange-500 text-white',
              ...
              <div className="space-y-12">
                {orders.map((product) => (
                  <Fragment key={product.id}>
                    ...
                    <div className="mt-6">
                      <p className={`font-medium px-4 py-2 rounded-full inline-block ${statusStyles[product.status] || 'bg-gray-200 text-black'}`}>
