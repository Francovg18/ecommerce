    ...
    return (
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        ...
        <div className="text-sm border-b border-gray-200 mt-2 pb-5 sm:flex sm:justify-between">
          <dl className="flex">
            <dt className="text-gray-500">Transaccion ID: &nbsp;</dt>
          ...
          <div className="space-y-24">
            ...
            >
              ...
              <div className="mt-6 sm:col-span-7 sm:mt-0 md:row-end-1">
                ...
                <p className="font-medium text-gray-900 mt-1">Transaccion ID: {product.transaction_id}</p>
              ...
              <div className="sm:col-span-12 md:col-span-7">
                ...
                <div className="mt-6">
                  ...
                  <div className="hidden sm:grid grid-cols-4 font-medium text-gray-600 mt-6">
                    <div className="text-midnight-blue">Pedido realizado</div>
