                      ...
                      <div className="sm:col-span-12 md:col-span-7">
                        ...
                        <div className="mt-6">
                          <div className="bg-gray-200 rounded-full overflow-hidden">
                            <div
                              className={`h-2 ${product.step === 0 ? 'bg-red-500' :
                                product.step === 1 ? 'bg-yellow-500' :
                                product.step === 2 ? 'bg-blue-500' :
                                product.step === 3 ? 'bg-green-500' :
                                'bg-indigo-600'} rounded-full`}
                              style={{ width: `${(product.step / 4) * 100}%` }}
                            />
                          </div>

                          <div className="hidden sm:grid grid-cols-5 font-medium text-gray-600 mt-6">
                            <div className={classNames(product.step >= 0 ? 'text-red-500' : '', 'text-center')}>
                              Pedido realizado
                            </div>
                            <div className={classNames(product.step >= 1 ? 'text-yellow-500' : '', 'text-center')}>
                              Procesando
                            </div>
                            <div className={classNames(product.step >= 2 ? 'text-blue-500' : '', 'text-center')}>
                              Enviado
                            </div>
                            <div className={classNames(product.step >= 3 ? 'text-green-500' : '', 'text-center')}>
                              En camino
                            </div>
                            <div className={classNames(product.step >= 4 ? 'text-indigo-600' : '', 'text-center')}>
                              Entregado
                            </div>
                          </div>
                        </div>
