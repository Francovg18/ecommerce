    ...
    const renderPaymentInfo = () => {
      if (!clientToken) {
        if (!isAuthenticated) {
          ...
          <button
            className="w-full bg-midnight-blue border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-#2A1350 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-indigo-500"
          >
            <Oval
              color='#fff'
              height={20}
