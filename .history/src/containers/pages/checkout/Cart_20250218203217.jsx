...
const Cart = ({
    ...
    const checkoutButton = () => {
        if (total_items < 1) {
            ...
            >
                <button
                className="w-full bg-midnight-blue border border-transparent rounded-md shadow-sm py-3 px-4 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-50 focus:ring-purple-night"
            >
                Buscar items
                </button>
            </Link>
    ...
    return (
      ...
      <div className="max-w-2xl mx-auto pt-16 pb-24 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
        <h1 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Productos en Carrito ({total_items})</h1>
          ...
          >
            ...
            <dl className="mt-6 space-y-4">
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-sm font-medium text-gray-900">0Bs</dd>
              </div>
              ...
              <div className="border-t border-gray-200 pt-4 flex items-center justify-between">
                ...
                <dd className="text-base font-medium text-gray-900">{amount.toFixed(2)}Bs</dd>
              </div>
            </dl>
