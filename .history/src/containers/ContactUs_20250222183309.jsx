...
// Cargar mapa solo cuando sea necesario (Lazy loading de iframe de Google Maps)
const MapIframe = lazy(() => import('../helpers/MapIFrame'));
    ...
    <Layout>
      <div className="px-6 sm:px-12 lg:px-20 py-16 bg-gradient-to-b from-white to-gray-200 min-h-screen">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-5xl font-extrabold text-gray-900">Sucursales</h2>
        </div>
