    ...
    const renderPagination = () => {
        ...
        return (
            <div className="flex justify-center mt-4 space-x-2">
                ...
                {startPage > 1 && (
                    <>
                        <button onClick={() => handlePageChange(1)} className="px-3 py-1 border rounded bg-gray-200">
                            1
                        </button>
                ...
                {endPage < totalPages && (
                    <>
                        ...
                        <button onClick={() => handlePageChange(totalPages)} className="px-3 py-1 border rounded bg-gray-200">
                            {totalPages}
                        </button>
                    </>
                )}
                    ...
                    <div className="flex items-center justify-between lg:hidden">
                        ...
                        <div className="fixed inset-0 flex z-40 lg:hidden">
                            ...
                            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-white">
                                ...
                                <form onSubmit={onSubmit} className="px-4 py-6 overflow-y-auto">
                                    <h3 className="text-sm font-medium text-gray-900">Categorías</h3>
                                    <ul className="text-sm font-medium text-gray-900 px-2 py-3">
                                        {
                                            categories &&
                                            categories !== null &&
