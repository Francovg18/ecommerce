  ...
  return (
    <Layout>
      <div className="min-h-full flex justify-center py-12 sm:px-6 lg:px-8">
        <div className="flex bg-white shadow-lg border border-gray-300 sm:rounded-lg w-full max-w-2xl flex-col md:flex-row">
          <div className="w-full md:w-[23%] bg-gradient-to-r from-crimson-red via-deep-rose via-dark-burgundy via-royal-purple to-midnight-blue rounded-t-lg md:rounded-l-lg md:rounded-tr-none rounded-br-lg md:rounded-br-none md:h-full md:py-8">
            {/* Agrega cualquier detalle visual que quieras aquí */}
          </div>
